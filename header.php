...
<div class="wrap">
	...
	<div class="navbar-container container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/logo-epanstwo.svgz" data-img="<?php echo get_template_directory_uri(); ?>
