                ...
                <div class="row">
                    ...
                    <div class="homeIntro-tile homeIntro-tile--3">
                        <a href="<?php the_field('link_1'); ?>"
                           class="homeIntro-tile-link"><?php the_field('title_1'); ?><i></i></a>
                    </div>
                    <div class="homeIntro-tile homeIntro-tile--4 homeIntro-tile--shifted">
                        <a href="<?php the_field('link_2'); ?>"
                           class="homeIntro-tile-link"><?php the_field('title_2'); ?><i></i></a>
                    </div>
                    <div class="homeIntro-tile homeIntro-tile--5">
                        <a href="<?php the_field('link_3'); ?>"
                           class="homeIntro-tile-link"><?php the_field('title_3'); ?><i></i></a>
                    </div>
...
if (have_rows('sections')):
    while (have_rows('sections')) : the_row(); ?>
        <section style="background-image: url(<?php echo get_sub_field('background'); ?>);"
                 class="homeWhite js-windowHeight">
            <div class="homeWhite-container container _vm">
                <div class="homeWhite-box <?php if (get_sub_field('box_right')) echo "homeWhite-box--right"; ?>">
                    <h1 class="homeWhite-title"><a
                            href="<?php the_sub_field('link'); ?>"><?php the_sub_field('title'); ?></a></h1>
